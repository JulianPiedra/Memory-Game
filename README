This is a quick-fun memory game built in python just set the paramenters to start the game
1. pairs or trios
...
[Download Memory Game](https://github.com/JulianPiedra/Memory-Game/archive/refs/heads/main.zip)
